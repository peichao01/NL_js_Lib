...
(function (win, undefined) {
    ...
    * @ method isChildNode(原名：isForefatherNode) --------判断是否是祖先节点
    *
    ...
    */
    NL.Elements = {
        ...
        */
        ...
        byCss: function (selector, context, results, seed) {
            //Sizzle
        },
        /**
        * @ target 根据ID 选择元素
        ...
        */
        getChild: function (dom, index, notCareTextNode) {
            ...
            return NL.Utils.getItem(ch, index);
        },
        /**
        ...
        */
        insert: function (dom, El_Arr_Html, index) {
            if (NL.Utils.isString(El_Arr_Html)) {
                var c = this.create(El_Arr_Html);
                this.insert(dom, c, index);
            } else if (NL.Utils.isArray(El_Arr_Html)) {
        ...
        *
        */
        before: function (dom, El_Arr_Html) {
        ...
        *
        */
        after: function (dom, El_Arr_Html) {
    ...
    NL.CSS = {
        ...
        */
        addClass: function (element, className) {
            ...
            if (!NL.Utils.isInArray(className, classNames))
        ...
        */
        removeClass: function (element, className) {
            var classNames = this.getArrayOfClassNames(element);
            for (var i = 0, len = classNames.length; i < len; index++) {
        ...
        */
        hasClass: function (Element, className) {
            var classNames = this.getArrayOfClassNames(element);
            return NL.Utils.isInArray(className, classNames);
        },
        /**
