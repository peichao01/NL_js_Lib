...
if(!Object.prototype.map){
    Object.prototype.map = function(fn, thisObj){
        ...
        for(var key in this){
            result[key] = fn.call(scope, this[key], this);
        }
        return result;
    }
}
    ...
    */
        ...
        */
        ...
        function _delegate(selector, type, fn, self){
            ...
            self.doms.forEach(function(dom){
                NL.$(selector, dom).forEach(function(dom){
                    nodes.push(dom);
                });
            });
    ...
    _NL.addProto({
        ...
        */
        ...
        append: function(Dom_Html_Arr){
            return this.insert(Dom_Html_Arr);
        },
        prepend: function(Dom_Html_Arr){
            return this.insert(Dom_Html_Arr, 0);
        },
        //options { returnContent: 'front'(default) || 'back' }
        insert: function(Dom_Html_Arr, index, options){
            var deepClone = true, returnBack = options&&options.returnContent=='back',returnNL;
